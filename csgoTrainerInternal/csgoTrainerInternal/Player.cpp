...
{
	static uint32_t engineBase = (uintptr_t)GetModuleHandle(L"engine.dll");
	return (int*) (*(uint32_t*)(engineBase + hazedumper::signatures::dwClientState) + hazedumper::signatures::dwClientState_MaxPlayer);
}
